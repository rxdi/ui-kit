...
"use strict";var e,t=this&&this.__decorate||function(e,t,r,o){var n,i=arguments.length,l=i<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,r,o);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(l=(i<3?n(l):i>3?n(t,r,l):n(t,r))||l);return i>3&&l&&Object.defineProperty(t,r,l),l},r=this&&this.__metadata||function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};Object.defineProperty(exports,"__esModule",{value:!0});const o=require("@rxdi/lit-html"),n=require("../settings");let i=class extends o.LitElement{constructor(){super(...arguments),this.palette="default"}OnUpdateFirst(){if("submit"===this.type){const e=this.getFormElement();if(e){const t=document.createElement("input");t.style.display="none",t.type=this.type,e.append(t),this.addEventListener("click",()=>t.click())}}}getFormElement(){let e,t="";for(const r of Array(1e3).fill("parentElement")){const o=this.findForm(t);if(o){e=o;break}t+=`.${r}`}return e}get(e={},t=""){return t.replace(/\[(.+?)\]/g,".$1").split(".").reduce((e,t)=>e[t]?e[t]:e,e)}findForm(e){let t;return(t=e?this.get(this.parentElement,e):this.parentElement)&&"FORM"!==t.tagName?null:t}};t([o.property({type:String}),r("design:type","function"==typeof(e=void 0!==n.PalettesUnion&&n.PalettesUnion)?e:Object)],i.prototype,"palette",void 0),t([o.property({type:String}),r("design:type",String)],i.prototype,"type",void 0),i=t([o.Component({selector:"rx-button",template(){return o.html`
      <style>
        :host {
          margin: 0;
          border: none;
...
//# sourceMappingURL=/ui-kit/main.f5ac3427.js.map