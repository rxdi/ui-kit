...
export interface IQuery {
  ...
  getConsultantSkill?: IConsultantQuestSkillType | null;
  getHomepageStats?: IStatisticsType | null;
  getOrganizationSkills?: IOrganizationQuestSkillListType | null;
  getOrganizationSkill?: IOrganizationQuestSkillType | null;
  ...
  listBritishQuizPages?: IQuizPagesListType | null;
  ...
  getQuestSkill?: IQuestSkillType | null;
}
...
/**
    description?: Simple quiz page type
  */
...
/**
    description?: Simple quiz question type
  */
...
export type IQuestSkillTemplateEnumTypeEnum =
  | 'FTF'
  | 'MCI'
  | 'VPF'
  | 'MVP'
...
export interface IQuestSkillType {
  __typename?: 'QuestSkillType';
  id?: string | null;
  description?: string | null;
  title?: string | null;
  percentage?: number | null;
...
export interface IMutation {
  ...
  changeOrganizationToConsultant?: IConsultantType | null;
  ...
  changeConsultantToOrganization?: IOrganizationType | null;
